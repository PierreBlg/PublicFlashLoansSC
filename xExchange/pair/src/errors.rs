...
pub static ERROR_NO_FLASH_LOAN_SC_SET: &[u8] = b"The Flash Loan SC has not been set";
pub static ERROR_CALLER_IS_NOT_FLASH_LOAN_SC: &[u8] = b"Caller is not flash loan SC";
pub static ERROR_ONE_BORROW_NOT_GIVEN_BACK: &[u8] = b"One of the borrowed token amount was not given back";
pub static ERROR_TOO_MUCH_TOKENS_GIVEN_BACK: &[u8] = b"Too much tokens given back";
pub static ERROR_NOT_ENTIRELY_GIVEN_BACK: &[u8] = b"One of the borrowed token amount was not entirely given back";