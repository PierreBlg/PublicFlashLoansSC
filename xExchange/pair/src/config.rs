    ...
    token_send::TokenSendModule + permissions_module::PermissionsModule + pausable::PausableModule
{
    ...
    fn set_fee_percent(&self, total_fee_percent: u64, special_fee_percent: u64, flashloan_fee_percent : u64) {
        self.require_caller_has_owner_or_admin_permissions();
        self.set_fee_percents(total_fee_percent, special_fee_percent, flashloan_fee_percent);
    }

    fn set_fee_percents(&self, total_fee_percent: u64, special_fee_percent: u64, flashloan_fee_percent : u64) {
        require!(
        ...
        self.flashloan_fees_percent().set(flashloan_fee_percent);
    }

    #[endpoint(setFlashLoanSC)]
    fn set_flash_loan_sc(&self, address : ManagedAddress) {
        self.require_caller_has_owner_permissions();
        self.flash_loan_sc().set(address);
    }
    ...
    #[view(getFlashloanFee)]
    #[storage_mapper("flashloan_fees_percentage")]
    fn flashloan_fees_percent(&self) -> SingleValueMapper<u64>;
    ...
    #[view(flashLoanSC)]
    #[storage_mapper("flash_loan_sc")]
    fn flash_loan_sc(&self) -> SingleValueMapper<ManagedAddress>;
